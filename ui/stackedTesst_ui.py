...
class Ui_main_screen_widget(object):
    def setupUi(self, main_screen_widget):
        ...
        self.table_usuarios = QTableWidget(self.page_usuarios)
        ...
        self.table_usuarios.setGeometry(QRect(20, 160, 781, 531))
        self.table_usuarios.setStyleSheet(u"QHeaderView::section{\n"
"	font-weight: bold;\n"
...
"}")
        ...
        self.table_usuarios.horizontalHeader().setVisible(True)
        self.table_usuarios.horizontalHeader().setCascadingSectionResizes(False)
        self.table_usuarios.horizontalHeader().setDefaultSectionSize(155)
        self.table_usuarios.horizontalHeader().setProperty(u"showSortIndicator", False)
        self.table_usuarios.horizontalHeader().setStretchLastSection(True)
        self.table_usuarios.verticalHeader().setCascadingSectionResizes(False)
        self.table_usuarios.verticalHeader().setStretchLastSection(False)
...
"}")
        ...
        self.btn_exportExcel = QPushButton(self.layoutWidget)
...
"}")
        ...
        self.horizontalLayout_2.addWidget(self.btn_exportExcel)

        self.btn_exportPDF = QPushButton(self.layoutWidget)
...
"}")
        ...
        self.horizontalLayout_2.addWidget(self.btn_exportPDF)
