...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.icons.setGeometry(QRect(10, 10, 271, 841))
        self.icons.setStyleSheet(u"QWidget{\n"
"	background-color: rgb(0, 0, 0);\n"
"}")
        self.btn_home = QPushButton(self.icons)
        self.btn_home.setObjectName(u"btn_home")
        self.btn_home.setGeometry(QRect(30, 110, 75, 41))
        self.btn_home.setAutoFillBackground(False)
        icon = QIcon()
        icon.addFile(u"../res/lupa2.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_home.setIcon(icon)
        self.btn_home.setIconSize(QSize(24, 24))
        self.label = QLabel(self.icons)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(40, 29, 51, 51))
        self.label.setPixmap(QPixmap(u"../res/home2.png"))
        self.label.setScaledContents(True)
        self.label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.btn_home_2 = QPushButton(self.icons)
        self.btn_home_2.setObjectName(u"btn_home_2")
        self.btn_home_2.setGeometry(QRect(30, 180, 75, 41))
        self.btn_home_2.setAutoFillBackground(False)
        icon1 = QIcon()
        icon1.addFile(u"../res/restaurante2.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_home_2.setIcon(icon1)
        self.btn_home_2.setIconSize(QSize(24, 24))
        self.btn_home_3 = QPushButton(self.icons)
        self.btn_home_3.setObjectName(u"btn_home_3")
        self.btn_home_3.setGeometry(QRect(30, 260, 75, 41))
        self.btn_home_3.setAutoFillBackground(False)
        icon2 = QIcon()
        icon2.addFile(u"../res/plato2.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_home_3.setIcon(icon2)
        self.btn_home_3.setIconSize(QSize(24, 24))
        self.btn_home_4 = QPushButton(self.icons)
        self.btn_home_4.setObjectName(u"btn_home_4")
        self.btn_home_4.setGeometry(QRect(30, 350, 75, 41))
        self.btn_home_4.setAutoFillBackground(False)
        icon3 = QIcon()
        icon3.addFile(u"../res/pedido2.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_home_4.setIcon(icon3)
        self.btn_home_4.setIconSize(QSize(24, 24))
        self.btn_home_5 = QPushButton(self.icons)
        self.btn_home_5.setObjectName(u"btn_home_5")
        self.btn_home_5.setGeometry(QRect(30, 430, 75, 41))
        self.btn_home_5.setAutoFillBackground(False)
        icon4 = QIcon()
        icon4.addFile(u"../res/repartidor2.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_home_5.setIcon(icon4)
        self.btn_home_5.setIconSize(QSize(24, 24))
        self.btn_home_6 = QPushButton(self.icons)
        self.btn_home_6.setObjectName(u"btn_home_6")
        self.btn_home_6.setGeometry(QRect(30, 500, 75, 41))
        self.btn_home_6.setAutoFillBackground(False)
        icon5 = QIcon()
        icon5.addFile(u"../res/detalles2.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_home_6.setIcon(icon5)
        self.btn_home_6.setIconSize(QSize(24, 24))
        self.btn_home_7 = QPushButton(self.icons)
        self.btn_home_7.setObjectName(u"btn_home_7")
        self.btn_home_7.setGeometry(QRect(30, 570, 75, 41))
        self.btn_home_7.setAutoFillBackground(False)
        icon6 = QIcon()
        icon6.addFile(u"../res/usuario2.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_home_7.setIcon(icon6)
        self.btn_home_7.setIconSize(QSize(24, 24))
        ...
        self.label_2 = QLabel(self.page_consultas)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(360, 220, 91, 61))
